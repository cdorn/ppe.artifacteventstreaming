...
class MultipleWriterTest {
    ...
    private record ModelWriter(OntModel model, Dataset dataset, CountDownLatch latch, String name,
                               List<Object> values) implements Runnable {
    ...
    private record ModelReader(OntModel model, Dataset dataset, CountDownLatch latch, String name,
                               Boolean splitTransaction) implements Runnable {
