...
public interface ContainedStatement extends Statement {
	 ...
	 */
    Resource getContainerOrSubject();
	 ...
	 */
    Property getContainmentPropertyOrPredicate();
	 ...
	 */
    void augmentWithContainment(Resource container, Property containingProperty);
	 ...
	 */
    void transferToModel(OntModel model);
