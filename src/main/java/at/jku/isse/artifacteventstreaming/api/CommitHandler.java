...
public interface CommitHandler {
	...
	/**
	 * called just after a new write transaction is started, (for writes a lock is obtained)
	...
	/**
	 * before commit serves are called, write transaction still open and available to writes
	 */
