...
public class TypedSetWrapper extends UntypedSetWrapper {
	...
	public TypedSetWrapper(@NonNull  OntObject setOwner, @NonNull  OntRelationalProperty setProperty, @NonNull OntObject classOrDataRange) {	
		super(setOwner, setProperty.asProperty());
