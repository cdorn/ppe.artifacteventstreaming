...
public class TypedMapWrapper extends UntypedMapResource {
	...
	public TypedMapWrapper(OntObject mapOwner, OntObjectProperty mapEntryProperty, OntObject classOrDataRange, MapResourceType mapType) {
		super(mapOwner, mapEntryProperty, mapType);
